...
def run_query_redshift(query, save_path, db_name, start_time=None, end_time=None, interval_type=None):
    ...
    elif (start_time and end_time and interval_type) == 0:
...
def run_query_redshift_macro(query, save_path, db_name, start_time, end_time, interval_type):
...
if __name__ == '__main__':
    ...
    try:
        ...
        if interval_type:
            run_query_redshift_macro(query, save_path, db_name, start_time, end_time, interval_type)
